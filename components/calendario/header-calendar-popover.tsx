...
export function HeaderCalendarPopover() {
  ...
  return (
    <Popover>
      ...
      <PopoverContent
        align="end"
        className="w-[380px] rounded-[28px] border border-border bg-card p-4 text-card-foreground shadow-[0_20px_60px_rgba(0,0,0,0.12)]"
      >
        <div className="space-y-4">
          ...
          <Link
            href="/calendario"
            className="block rounded-2xl bg-black px-4 py-3 text-center text-sm font-medium text-white transition hover:bg-black/90 dark:bg-white/10 dark:text-white dark:backdrop-blur-md dark:hover:bg-white/20 border border-black/10 dark:border-white/10 shadow-sm"
          >
