...
export function StudentsPageContent({
    ...
    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      <div className="flex min-w-0 flex-col gap-3 sm:flex-1 sm:flex-row sm:items-center">
        <div className="relative min-w-0 flex-1">
          <Search className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-black/65 dark:text-muted-foreground" />

          <Input
            type="search"
            placeholder="Buscar aluno..."
            className="h-11 rounded-2xl bg-background pl-9 placeholder:text-black/65 dark:placeholder:text-muted-foreground"
            value={search}
            onChange={(e) => {
              setPage(1);
        ...
        <div className="grid grid-cols-[1fr_auto] gap-3 sm:flex sm:items-center">
          ...
          >
            <Filter className="h-4 w-4 text-black dark:text-foreground" />
  ...
  <div className="mt-4 flex flex-col gap-3 text-sm text-black/42 dark:text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
    <span>
